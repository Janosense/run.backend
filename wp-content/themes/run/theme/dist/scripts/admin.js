(function () {
  ...
  */
  ...
  var init_result_time_field_mask = function init_result_time_field_mask() {
    document.addEventListener('DOMContentLoaded', function (evt) {
      var container = document.querySelector('.carbon_fields_container_result_data');

      if (container) {
        var element = container.querySelector('input[name="carbon_fields_compact_input[_crb_result_time]"]');
        IMask(element, {
          mask: '`00:00:00{.00}',
          lazy: true,
          placeholderChar: ' '
  ...
  var init_imask = function init_imask() {
