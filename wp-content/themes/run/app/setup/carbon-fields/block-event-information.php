...
Block::make( __( 'Event information', 'run' ) )
	 ->add_fields( [
		 ...
		 Field::make( 'text', 'crb_event_info_distances', __( 'Event distances', 'run' ) )->set_required( true ),
	 ...
	 ->set_render_callback( function ( $fields, $attributes, $inner_blocks ) { ?>
		 <div class="event-info-block">
			 <div class="event-info-block__header">
				 <span class="event-info-block__date"><?php echo $fields['crb_event_info_date']; ?></span> <a
